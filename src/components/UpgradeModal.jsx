  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {message ||
            "Essa funcionalidade está disponível para usuários Premium. Faça upgrade para desbloquear."}
        </p>
        ...
        >
          ...
          {[
            ...
            "Mais liberdade para explorar o app",
            "Ferramentas e features futuras incluídas",
          ].map((item) => (
            <div
              key={item}
              style={{
