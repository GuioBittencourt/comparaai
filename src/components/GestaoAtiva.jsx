...
>
  ...
  >
    ...
    >
      ...
      <p style={{ textAlign: "center", fontSize: 9, color: C.textMuted, marginTop: 14, lineHeight: 1.5 }}>comparainvest — Gestão Ativa. Gastos resetam todo início de mês.{!isPremium && " Conta gratuita: máx. 4 categorias."}</p>
